...
import { IProtocolMetrics } from "../slices/AppSlice";
...
function HomeContent() {
  ...
  const elementData = [
    {"title":"Bonds & LP fees", "info":"Bond sales and LP Fees increase Treasury Revenue and lock in liquidity and help control NRK supply.", imgUrl:require("../assets/home/number-1.png")},
    {"title":"NoahArk Treasury", "info":"Treasury inflow is used to increase Treasury Balance and back outstanding NRK tokens and regulate staking APY.", imgUrl:require("../assets/home/number-2.png")},
    {"title":"NRK Token", "info":"Compounds yields automatically through a treasury backed currency with intrinsic value.", imgUrl:require("../assets/home/number-3.png")}
  ];
        ...
        <div className="content">
          <div className="info">
            <div className="left">
              ...
              <div className="info-two">NoahArkDAO is building a community-owned decentralized financial infrastructure to bring more stability and transparency for the world.</div>
              {/*<a href="/#/app/dashboard" className="enter-app" target="_blank">Enter App</a>*/}
              <div className="info-three">
                <a className="enter-app">Coming Soon</a>
                <a className="enter-app" target="_blank" href="https://discord.com/invite/KaTFSdmj9f">Discord</a>
              </div>
            </div>
            <div className="right">
          ...
          <div className="noahark-info-content">
            <div className="info-item">
              ...
              <div className="value">
                ...
                {/*</span> : <Skeleton variant="text" width={200}></Skeleton>}*/}
                --
              </div>
            </div>
            <div className="info-item">
        ...
        <div className="content">
          {
           ...
           {/*<CSSTransition in={howTitleTwoFade} timeout={300}  classNames={"how-title"} unmountOnExit>*/}
            <div className="how-title-one-box">
              <div className="title">How does <span>NoahArkDAO</span> work ?</div>
              <hr className="one-hr"/>
            </div>
           {/*</CSSTransition>*/}
           {/*<CSSTransition in={howTitleTwoFade} timeout={300}  classNames={"how-title"} unmountOnExit>*/}
          ...
          {/*<CSSTransition in={howTitleThreeFade} timeout={300}  classNames={"how-title"} unmountOnExit>*/}
            <div className="how-title-one-box">
              <div className="title">Our <span>Partners</span></div>
              <hr className="two-hr"/>
            </div>
          {/*</CSSTransition>*/}
          {/*<CSSTransition in={howTitleThreeFade} timeout={300}  classNames={"how-title"} unmountOnExit>*/}
